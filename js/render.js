...
function renderTasks() {
    ...
    function taskCard(task, vi) {
        ...
        const compactInline = '<div class="compact-inline">'+cDue+cNote+cRec+'<span class="compact-prio p-'+task.priority+'"></span><span class="compact-cat">'+escHtml(catLabel(task.category))+'</span></div>';
